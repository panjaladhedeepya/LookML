view: ib_data_portrait {
  ...
  parameter: target_select {
    ...
    default_value: "1"
    allowed_value: {
      label: "Segment 1 - Boaters, Sailors, Likely Investors"
      value: "1"
    }
    allowed_value: {
      label: "Segment 2 -  Campers and Hikers"
      value: "2"
    }
    # allowed_value: {
...
#
  ...
  dimension: target_label {
    ...
    sql:  CASE WHEN ${TABLE}.target_flg = '1' THEN 'Segment 1 - Boaters, Sailors, Likely Investors'
      WHEN ${TABLE}.target_flg = '2' THEN 'Segment 2 -  Campers and Hikerss'
...
###############################################################################################
      ...
      dimension: cib1270_px_lifestage_segment {
        ...
        sql: ${TABLE}.cPX001270_01_px_lifestage_segment ;;
      }
      ...
      dimension: cib1271_px_lifestage_group {
        ...
        sql: ${TABLE}.cPX001271_01_px_lifestage_group ;;
      }
      ...
      dimension: cib1274_px_lifestage_insurance_group {
        ...
        sql: ${TABLE}.cPX001274_01_px_lifestage_insurance_group ;;
      }
